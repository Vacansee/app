<template>
  <div id="mapBox">
    <svg viewBox="0 0 1024 1706" id="map">
      <g id="bg">
        <rect width="1024" height="1706" style="fill: transparent;" />
        <g id="stair">
      ...
      <g id="buildings">
        <rect id="mask" width="10000px" height="100000px" />
        <path id="CBIS"
      ...
      <foreignObject style="pointer-events: none;" x="100" y="200" width="100%" height="100%">
        <div class="map-overlays">
          <p id="test" class="titles" style="top: 629px; left: 352px;">DCC </p>
        </div>
      </foreignObject>
    </svg>
  </div>
...
export default {
  ...
  mounted() {
    ...
    if (this.lastRatio < this.threshold) { // switch to portrait
      map.style.transform = "rotate(90deg)"
      test.style.transform = "rotate(-90deg)"
      map.style.width = this.lastY
    }
    else map.style.width = this.lastX
  ...
  methods: {
    ...
    windowEventHandler() {
      ...
      if (ratio < this.threshold) { // portrait mode
        ...
        else if (y > this.lastY) map.style.width = y
      }
      ...
      if (ratio > this.threshold) { // landscape mode
        ...
        else if (x > this.lastX) map.style.width = x
      }
