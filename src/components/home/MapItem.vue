    ...
    <svg viewBox="0 0 1024 1706" id="map">
      <g id="bg">
        ...
        <g id="other">
          ...
          <path id="Office of Public Safety"
      ...
      <g id="buildings">
        ...
        <path id="Jonsson Engineering Center"
        ...
        <path id="Cogswell Laboratory" d="m294.8 1022.3 42.7 3.5 1.7-16.5 28.5 1.9 2.5-27.6-72-6.5-2.4 31.5-1 13.7Z" />
        <path id="Folsom Library"
          d="M184.5 917.1h3.7l.1 5 32.9-1-.1-5.3h4.2l-1.4-56.5-4.3.1-.2-5.8-31.7.8.2 6.4-4.8.2 1.4 56.1Z" />
        <path id="Russel Sage Laboratory"
        ...
        <path id="Voorhees Computing Center"
          d="m241.4 894.8 6.8-.4.4 7.8 26.6-.7v2.6l22.4-.2-.5-5.3 4.5-2.3 2.7-4.1-.7-5-2-3-4.2-1.9-.4-5.7-23 .5.5 3-27 .3v7.5l-6.2.2.1 6.7Z" />
        <path id="Materials Research Center" d="m192.8 997.6 34 2.5 2.2-29-15-1-19-1.4-2.2 29Z" />
        <path id="Walker Laboratory"
          d="m166.2 751 14.8 3 2-9.8 11.4 2.3 3-15.5 6.8 1.4 2-10-7.3-1.4 1.9-9.4-3-.6-9.7-2-2 10-8.3-1.6-1.7 8.5-4.7-1-5.2 26.1Z" />
        <path id="Ricketts Building" d="m374.1 697 27-1 27.4-1.1-.7-17.5-54.4 2 .7 17.5Z" />
        <path id="Mueller Center"
          d="m633.2 875.7 55.4 1 .1-3.8h2.5l.2-11.2h-5.3v-1.8l-35.1-.7v-3.7l-5.3-.2-.1 7.2h-3v-1l-9-.2-.4 14.4Z" />
        <path id="Greene Building" d="m284.2 810.5 46-.7-.6-19.8-46.1 1.3.1 9.4.6 9.8Z" />
        <path id="Amos Eaton Hall" d="M173 812.6h1.7l9.9.2 32.8-.1.5-20.3-44.5.7-.5 16v3.5Z" />
        <path id="Pittsburgh Building"
          d="M103.3 720.1h9.9l-.3 2.2h13v-2.2l9.8.6v-20.3H130l-.2-4-8.6-1.5-11 1.3v4.2l-6.3.2-.6 19.5Z" />
        <path id="Troy Building" d="m319.2 694.6 19.1-.4 20-.5-.5-17.1-9.8.2V672l-19 .4.2 5.4-10.3.2.3 16.6Z" />
        <path id="Carnegie Building" d="m130.7 798 19 3.6 6.3-32.5-18.5-3.5-1.3 6.9-1.6-.3-1.7 8.8-1.6 8.8 1 .2-1.6 8Z" />
        <path id="Winslow Building" d="m42.6 768.6 12 .5 1.6-41-12.2-.4-1.4 41Z" />
        <path id="Lally School of Management" d="m234.4 812 30.5.5v-2l.3-11.3-15.3-.3-15.3-.2-.2 13.3Z" />
        <path id="RPI Student Union"
